...
- [default-configuration-only](.hod/rules/default-configuration-only.md): What this project holds when the user asks for an application.
- [laptop-and-dotfiles](.hod/rules/laptop-and-dotfiles.md): Where a change lands when the user asks for a change on this laptop.
- [no-claude-memory](.hod/rules/no-claude-memory.md): Where a lesson lands, and the ban on Claude memories.
